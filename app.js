...
root.render(React.createElement(CTFGenerator));  "flag": "CTF{something_unique}",
  "points": 100,
        ...
        {!challenge && !loading && (
          <div className="grid md:grid-cols-3 gap-4 mt-8">
            ...
            <div className="bg-gradient-to-br from-green-600/20 to-emerald-600/20 p-6 rounded-xl border border-green-500/30">
              ...
              <p className="text-sm text-gray-300">Every challenge is freshly generated and original</p>
            </div>
          </div>
        )}
      </div>
